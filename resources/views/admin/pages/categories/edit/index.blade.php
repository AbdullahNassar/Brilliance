              ...
              <div class="col-lg-6">
                <div id="fnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input value="{{$category->translate('en', true)->name}}" class="form-control" type="text" name="translatedAttrs[en][name]" data-parsley-class-handler="#fnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div id="lnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input value="{{$category->translate('ar', true)->name}}" class="form-control" type="text" name="translatedAttrs[ar][name]" data-parsley-class-handler="#lnWrapper" required>
                  </div>
                </div>
              </div>
            </div><!-- row -->
...
@endsection
@include('admin.pages.categories.edit.scripts')