              ...
              <div class="col-lg-4">
                <div id="fnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input value="{{$subcategory->translate('en', true)->name}}" class="form-control" type="text" name="translatedAttrs[en][name]" data-parsley-class-handler="#fnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div id="lnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input value="{{$subcategory->translate('ar', true)->name}}" class="form-control" type="text" name="translatedAttrs[ar][name]" data-parsley-class-handler="#lnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                      ...
                      <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <select class="form-control pmd-select2 select2-show-search" name="category_id" data-parsley-class-handler="#slWrapper"
                          ...
                          @foreach($categories as $category)
                            <option value="{{$category->id}}" @if($subcategory->category_id == $category->id) selected @endif>{{$category->translate('en', true)->name}}</option>
                          @endforeach
                        </select>
...
@endsection
@include('admin.pages.sub_categories.edit.scripts')