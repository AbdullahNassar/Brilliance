              ...
              <div class="col-lg-6">
                <div id="lnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input class="form-control" type="email" name="email" data-parsley-class-handler="#lnWrapper" required autocomplete="off">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div id="fnWrapper1" class="parsley-input">
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <input class="form-control" type="password" name="password" data-parsley-class-handler="#fnWrapper1" required autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
...
@endsection
@include('admin.pages.users.add.scripts')