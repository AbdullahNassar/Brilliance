              ...
              <div class="col-lg-6">
                <div class="user-img-upload">
                  <div class="fileUpload user-editimg">
                      <span><i class="fa fa-camera"></i> Change</span>
                      <input type="file" id="imgInp" class="upload" name="image" value="{{$country->image}}">
                  </div>
                  <img src="{{asset('images/countries/'.$country->image)}}" id="blah" class="img-circle" alt="">
                ...
                <div class="col-lg-6">
                  <div class="user-img-upload">
                      <div class="fileUpload user-editimg">
                          <span><i class="fa fa-camera"></i> Change</span>
                          <input type="file" id="imgInp2" class="upload" name="flag" value="{{$country->flag}}">
                      </div>
                      <img src="{{asset('images/countries/'.$country->flag)}}" id="blah2" class="img-circle" alt="">
                      <p>Flag : (30 x 20)</p>
                  </div>
              </div>
              <hr>
              <div class="col-lg-4">
                <div id="fnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input value="{{$country->translate('en', true)->name}}" class="form-control" type="text" name="translatedAttrs[en][name]" data-parsley-class-handler="#fnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div id="lnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input value="{{$country->translate('ar', true)->name}}" class="form-control" type="text" name="translatedAttrs[ar][name]" data-parsley-class-handler="#lnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-4">
                <div id="lnWrapper2" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input class="form-control" value="{{$country->code}}" type="text" name="code" data-parsley-class-handler="#lnWrapper2" required>
                  </div>
                </div>
              </div>
            </div><!-- row -->
...
@endsection
@include('admin.pages.countries.edit.scripts')