...
@php $key = 0; @endphp
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      ...
      <p class="mg-b-0">Forms are used to collect doctor information with different element types of input, select, checkboxes, radios and more.</p>
    </div>
                              ...
                              <div class="col-lg-6">
                                  <div id="fnWrapper1" class="parsley-input">
                                      <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                          ...
                                          <input class="form-control" type="text" name="mobile" data-parsley-class-handler="#fnWrapper1" autocomplete="off">
                                      </div>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                <div id="fnWrapper2" class="parsley-input">
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input class="form-control" type="text" name="email" data-parsley-class-handler="#fnWrapper2" autocomplete="off">
                                    </div>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="form-group custom-inputfile" style="margin-left: 10px !important;">
                                      <input type="file" name="cv" id="file-6" class="inputfile inputfile-6">
                              ...
                              <div class="col-lg-6">
                                <div id="fnWrapper6" class="parsley-input">
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input class="form-control" type="text" name="fees_per_day" data-parsley-class-handler="#fnWrapper6" autocomplete="off">
                                    </div>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div id="lnWrapper7" class="parsley-input">
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input class="form-control" type="text" name="total_fees" data-parsley-class-handler="#lnWrapper7" autocomplete="off">
                                    </div>
                                </div>
                              </div>
                          </div>
                            ...
                            <div class="col-lg-12">
                                <div id="fnWrapper99" class="parsley-input">
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input class="form-control" type="text" name="notes" data-parsley-class-handler="#fnWrapper99" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                          </div>
...
@endsection
@include('admin.pages.doctors.add.scripts')