...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Diploma Intakes Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Diploma Intakes Form</h4>
              ...
              <div class="col-lg-6">
                <div id="lnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input type="text" class="form-control datepicker dpd" data-date-format="dd-mm-yyyy" name="start" data-parsley-class-handler="#lnWrapper" autocomplete="off">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
...
@endsection
@include('admin.pages.diploms.intakes.add.scripts')