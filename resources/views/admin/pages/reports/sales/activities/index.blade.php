...
@endsection
@section('title','Advisors Activities Report')
@section('styles')
    <!-- vendor css -->
          ...
          <div class="br-section-wrapper" id="printableArea">
              <div class="row">
                <div class="col-md-12" style="text-align:center;">
                    <h4 class="tx-gray-800 mg-b-5">Advisors Activities Report</h4>
                </div>
                <div class="col-md-12">
                            ...
                            <tbody>
                                @foreach($activities as $item)
                                    <tr @if($item->temperature == "Cold") style="color:#5baefb !important;" @elseif($item->temperature == "Warm") style="color:#f3d67b !important;" @elseif($item->temperature == "Hot") style="color:#fd3131 !important;" @endif>
                                        ...
                                        <th @if($item->temperature == "Cold") style="color:#5baefb !important;" @elseif($item->temperature == "Warm") style="color:#f3d67b !important;" @elseif($item->temperature == "Hot") style="color:#fd3131 !important;" @endif><a href="{{ route('lead.profile' , ['id' => $item->id]) }}" @if($item->temperature == "Cold") style="color:#5baefb !important;" @elseif($item->temperature == "Warm") style="color:#f3d67b !important;" @elseif($item->temperature == "Hot") style="color:#fd3131 !important;" @endif>{{$item->salesLead->full_name}}</a></th>
                                        <th @if($item->temperature == "Cold") style="color:#5baefb !important;" @elseif($item->temperature == "Warm") style="color:#f3d67b !important;" @elseif($item->temperature == "Hot") style="color:#fd3131 !important;" @endif>{{$item->salesLead->phone_number}}</th>
                                        <th @if($item->temperature == "Cold") style="color:#5baefb !important;" @elseif($item->temperature == "Warm") style="color:#f3d67b !important;" @elseif($item->temperature == "Hot") style="color:#fd3131 !important;" @endif>{{$item->salesLead->email}}</th>
                                        ...
                                        <th @if($item->temperature == "Cold") style="color:#5baefb !important;" @elseif($item->temperature == "Warm") style="color:#f3d67b !important;" @elseif($item->temperature == "Hot") style="color:#fd3131 !important;" @endif>{{$item->salesLead->activity_status}} @if($item->salesLead->next_call != null) | {{$item->salesLead->next_call}} @endif</th>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
@endsection
@include('admin.pages.reports.sales.activities.scripts')