    ...
    $(document).ready(function() {
        ...
        $('.add_form_field3').click(function(){
            $('.payment').append('<div id="empty_payment_'+(num3)+'" class="col-lg-12"><p> <p></div>'+
                                   ...
                                   '<div class="col-lg-2" id="remove_payment3_'+(num3)+'"><div class="form-group pmd-textfield pmd-textfield-floating-label"><label class="control-label">Euro = EGP</label><input type="text" class="form-control" name="payments['+num3+'][egp_amount]" autocomplete="off"/></div></div>'+
                                   '<div class="col-lg-2" id="remove_payment4_'+(num3)+'"><div class="form-group pmd-textfield pmd-textfield-floating-label"><label class="control-label">Euro</label><input type="text" class="form-control" name="payments['+num3+'][euro_amount]" autocomplete="off"/></div></div>'+
                                   '<div class="col-lg-2" id="remove_payment5_'+(num3)+'"><div class="form-group pmd-textfield pmd-textfield-floating-label"><label class="control-label">USD</label><input type="text" class="form-control" name="payments['+num3+'][usd_amount]" autocomplete="off"/></div></div>'+
        ...
        $('#payment_form').on('submit', function(event){
                ...
                $.ajax({
                    ...
                    url:"{{ route('students.addmultipay') }}",
                    method:"POST",
