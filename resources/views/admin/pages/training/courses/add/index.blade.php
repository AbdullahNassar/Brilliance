...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.trainingcourses')}}">TrainingCourses</a>
            <span class="breadcrumb-item active">TrainingCourses Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">TrainingCourses Form</h4>
...
@endsection
@include('admin.pages.training.courses.add.scripts')