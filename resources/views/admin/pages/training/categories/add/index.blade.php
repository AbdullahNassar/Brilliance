...
@endsection
@section('title','TrainingCategories')
@section('styles')
...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.trainingcategories')}}">TrainingCategories</a>
            <span class="breadcrumb-item active">TrainingCategories Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">TrainingCategories Form</h4>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="ckbox">
                    <input id="ckbox1" name="status" type="checkbox">
                    <span>Active</span>
                  </label>
                </div>
              </div>
...
@endsection
@include('admin.pages.training.categories.add.scripts')