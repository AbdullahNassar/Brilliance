...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        ...
        <p class="mg-b-0">Forms are used to collect category information with different element types of input, select, checkboxes, radios and more.</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <div class="form-layout form-layout-1">
            <form class="parsley-style-1" id="category_form" method="post" data-parsley-validate>
            {{csrf_field()}}
              ...
              <div class="col-lg-6">
                <div id="fnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input class="form-control" value="{{$category->name}}" type="text" name="name" data-parsley-class-handler="#fnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="ckbox">
                    <input id="ckbox1" name="status" type="checkbox" @if($category->status == 1) value="1" checked @else value="0" @endif>
                    <span>Active</span>
                  </label>
                </div>
              </div>
...
@endsection
@include('admin.pages.training.categories.edit.scripts')