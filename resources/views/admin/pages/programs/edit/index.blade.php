...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Programs Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Programs Form</h4>
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <div class="form-layout form-layout-1">
            <form class="parsley-style-1" id="program_form" method="post" data-parsley-validate>
            {{csrf_field()}}
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div id="fnWrapper" class="parsley-input">
                  <div class="form-group pmd-textfield pmd-textfield-floating-label">
                      ...
                      <input class="form-control" value="{{$program->name}}" type="text" name="name" data-parsley-class-handler="#fnWrapper" required>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                      ...
                      <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <select class="form-control pmd-select2 select2-show-search" name="university_id" data-parsley-class-handler="#slWrapper"
                          ...
                          @foreach($universities as $university)
                            <option value="{{$university->id}}" @if($university->id == $program->university_id) selected @endif>{{$university->name}}</option>
                          @endforeach
                        </select>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="ckbox">
                    <input id="ckbox1" name="active" type="checkbox" @if($program->active == 1) value="1" checked @else value="0" @endif>
                    <span>Active</span>
                  </label>
                </div>
              </div>
...
@endsection
@include('admin.pages.programs.edit.scripts')