...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{route('admin.programs')}}">Program Courses</a>
            <span class="breadcrumb-item active">Program Courses Form</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Program Courses Form</h4>
                      ...
                      <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <select class="form-control pmd-select2 select2-show-search" name="program_id" data-parsley-class-handler="#slWrapper"
                          ...
                          @foreach($programs as $program)
                            <option value="{{$program->id}}" @if($program->id == $course->program_id) selected @endif>{{$program->name}} | {{$program->university->name}}</option>
                          @endforeach
                        </select>
...
@endsection
@include('admin.pages.programs.courses.edit.scripts')