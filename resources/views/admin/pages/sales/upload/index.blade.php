      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <div class="form-layout form-layout-1">
            <form class="parsley-style-1" id="upload_form" method="post" data-parsley-validate>
            {{csrf_field()}}
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group custom-inputfile" style="margin-left: 10px !important;">
                  <input type="file" name="file" id="file-6" class="inputfile inputfile-6">
...
@endsection
@include('admin.pages.marketing.upload.scripts')