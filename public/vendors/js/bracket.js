...
$(document).ready(function() {
    ...
    // This will auto show sub menu using the slideDown()
    // when top level menu have a class of .show-sub
    $('.show-sub-sub + .br-menu-sub-sub').slideDown();
    ...
    $(document).on('mouseover', function(e) {
        ...
        if ($('body').hasClass('collapsed-menu') && $('#btnLeftMenu').is(':visible')) {
            ...
            if (targ) {
                ...
                var menuText = $('.menu-item-label-sub,.menu-item-arrow-sub');
                menuText.removeClass('d-lg-none');
                menuText.removeClass('op-lg-0-force');
                ...
                // hide current shown menu
                $('.show-sub-sub + .br-menu-sub-sub').slideUp();
    ...
    // This will show sub navigation menu on left sidebar
    // only when that top level menu have a sub menu on it.
    $('.br-menu-link-sub').on('click', function() {
        var nextElem = $(this).next();
        var thisLink = $(this);
        ...
        if (nextElem.hasClass('br-menu-sub-sub')) {
            ...
            if (nextElem.is(':visible')) {
                thisLink.removeClass('show-sub-sub');
                nextElem.slideUp();
            } else {
                $('.br-menu-link-sub').each(function() {
                    $(this).removeClass('show-sub-sub');
                });
                ...
                thisLink.addClass('show-sub-sub');
                nextElem.slideDown();
            }
            return false;
        }
